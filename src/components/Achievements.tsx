        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7">
          {achievements.map((ach) => (
            ...
            >
              {/* Gradient banner */}
              <div
                className={`relative h-40 bg-gradient-to-br ${ach.gradient} flex items-center justify-center overflow-hidden`}
              >
                {/* Decorative circles */}
                ...
                {/* Result badge */}
                <div
                  className={`absolute top-4 right-4 ${ach.badgeColor} text-white text-xs font-bold px-3.5 py-1.5 rounded-full shadow-lg tracking-wide`}
                >
                  {ach.badge}
                </div>
              </div>
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="text-base font-bold text-text mb-1 group-hover:text-primary transition-colors leading-snug">
                  {ach.title}
                </h3>
