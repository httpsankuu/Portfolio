...
const education: EducationEntry[] = [
  ...
  },
  {
    ...
    institution: "Sunshine Public School",
    years: "2023 – 2024",
    focus:
      "Completed senior secondary education with Physics, Chemistry, and Mathematics as core subjects — building analytical and problem-solving fundamentals.",
    highlights: ["PCM Stream", "Science"],
    icon: "🏫",
  },
  {
    ...
    years: "2021 – 2022",
    focus:
      "Completed secondary education with a strong academic foundation across all core subjects.",
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-6">
                ...
                <div className="flex-1">
                  ...
                  {edu.highlights && edu.highlights.length > 0 && (
                    <div className="flex flex-wrap gap-2 mb-4">
                      {edu.highlights.map((h) => (
                        <span
                          key={h}
                          className="px-3 py-1 bg-emerald-500/15 text-emerald-400 text-xs font-semibold rounded-full border border-emerald-500/25"
                        >
                          {h}
                        </span>
                      ))}
                  ...
                  {/* Coursework pills — only for B.Tech */}
